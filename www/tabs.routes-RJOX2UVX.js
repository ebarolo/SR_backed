...
var routes = [
  {
    ...
    children: [
      {
        path: "chat_bot",
        loadComponent: () => import("./chat_bot.page-BK3YBR3D.js").then((m) => m.ChatBotPage)
      },
      {
        path: "import_recipe",
        loadComponent: () => import("./import_recipe.page-B3TLVX3J.js").then((m) => m.ImportRecipePage)
      },
      {
        path: "ricette",
...
//# sourceMappingURL=tabs.routes-RJOX2UVX.js.map
